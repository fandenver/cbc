...
if (sliderPage) {
  document.addEventListener('DOMContentLoaded', function () {
    const sliderButtonRight = document.getElementsByClassName(
      'slider-page_arrow-button',
    )[0];
    const sliderButtonLeft = document.getElementsByClassName(
      'slider-page_arrow-button',
    )[1];
    const textImage = document.querySelector('.slider-page_text-block > span');
    const circleSliderOne = document.querySelector(
      'ul.slider-page_pagination-container > li:nth-child(1)',
    );
    const circleSliderTwo = document.querySelector(
      'ul.slider-page_pagination-container > li:nth-child(2)',
    );
    const circleSliderThree = document.querySelector(
      'ul.slider-page_pagination-container > li:nth-child(3)',
    );
    const circleSliderFour = document.querySelector(
      'ul.slider-page_pagination-container > li:nth-child(4)',
    );
    const circleSliderFive = document.querySelector(
      'ul.slider-page_pagination-container > li:nth-child(5)',
    );

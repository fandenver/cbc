document.addEventListener('DOMContentLoaded', function () {
  const openModalRequestCallBtn = document.querySelector(
    '.bottom-services_request-call',
  );
  const modalRequestCall = document.querySelector('.modal_request-call');
  const successModalBtn = document.querySelector(
    '.request-call-modal_send-request',
  );
  ...
  const commonMainMenuSelector = document.querySelectorAll(
    '.commonSpanMainMenu',
  );
